...
from fairseq.modules import LayerNorm, MultiheadAttention_ST
...
class TransformerEncoderLayerBase_ST(nn.Module):
    """Encoder layer block.
    ...
    *cfg.encoder.normalize_before* to ``True``.
    ...
    def build_fc1(self, input_dim, output_dim, q_noise, qn_block_size):
        return quant_noise(
            Linear_ST(input_dim, output_dim),
...
class TransformerEncoderLayer_ST(TransformerEncoderLayerBase_ST):
...
class TransformerDecoderLayerBase_ST(nn.Module):
    """Decoder layer block.
...
# backward compatible with the legacy argparse format
class TransformerDecoderLayer(TransformerDecoderLayerBase_ST):
    def __init__(
