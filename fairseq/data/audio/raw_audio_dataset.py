    ...
    def __init__(
        ...
        **mask_compute_kwargs,
        ...
        with open(manifest_path, "r") as f:
            ...
            if '/home/clai24' in self.root_dir:
                self.root_dir = self.root_dir.replace('/home/clai24', '/data1/dataset_asr')
                # self.root_dir = self.root_dir.replace('/home/clai24', '/data1/yf22/dataset_asr')
