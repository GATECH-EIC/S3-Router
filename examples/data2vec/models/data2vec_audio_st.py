...
from fairseq.models.wav2vec.wav2vec2_st import TransformerEncoder_ST, Wav2Vec2Config
...
@register_model("data2vec_audio_st", dataclass=Data2VecAudioConfig)
class Data2VecAudioModel(BaseFairseqModel):
    def __init__(self, cfg: Data2VecAudioConfig):
        ...
        self.encoder = TransformerEncoder_ST(cfg)  # self.encoder = TransformerEncoder(cfg)
